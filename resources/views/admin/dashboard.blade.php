...
<div class="container mt-4">
    <div class="card shadow rounded-4 border-0">
        ...
        <div class="card-body">
            ...
            <p class="mb-4">Kamu dapat mengelola <strong>event</strong>, <strong>peserta</strong>, <strong>kehadiran</strong>, dan <strong>sertifikat</strong> di sini.</p><div class="d-grid gap-2 d-md-block">
